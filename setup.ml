...
(* OASIS_START *)
(* DO NOT EDIT (digest: afc966b373a53bc20af6873ad0c0d734) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("sequmedoc", OCamlbuildDocPlugin.doc_build "src/lib/")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("sequmedoc", OCamlbuildDocPlugin.doc_clean "src/lib/")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_data_files =
                        [
                           ("../script/make_pbs_script.ml", Some "$bindir");
                           ("../script/full_sample_sheet.ml", Some "$bindir")
                        ];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Documentation of the Sequme library";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
